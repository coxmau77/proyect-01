...
const onLoad = () => {
  ...
  // const isLoggedIn = false; // Ejemplo de validación con token en localStorage
...
const logOut = () => {
  ...
  redirect("login.html"); // Redirige al login después del cierre de sesión
};

// Exporta las funciones para que puedan ser reutilizadas en otros archivos
export { redirect, onLoad, logOut };
